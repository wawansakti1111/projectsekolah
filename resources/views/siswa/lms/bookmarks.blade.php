            ...
            <div class="relative z-10 py-6 px-8">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-green-100 text-sm mt-1">Materi yang Anda tandai untuk dipelajari nanti</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="py-8 md:py-12 bg-gradient-to-br from-green-50 via-white to-emerald-50 min-h-screen relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="mb-8 animate-fade-in-up">
                <form action="{{ route('siswa.lms.bookmarks') }}" method="GET" class="flex flex-col sm:flex-row gap-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                @forelse ($materials as $material)
                    <div x-data="{ isBookmarked: {{ in_array($material->id, $bookmarkedIds) ? 'true' : 'false' }} }"
                         class="group relative bg-white/80 backdrop-blur-xl overflow-hidden shadow-2xl rounded-3xl border border-green-200/50 hover:shadow-3xl hover:-translate-y-2 transition-all duration-500 transform animate-fade-in-up">
                        ...
                        <div class="p-6 md:p-8 flex flex-col h-full">
                            ...
                            <a href="{{ route('siswa.lms.show', $material) }}"
                               class="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] group/btn">
                    ...
                    <div class="col-span-3">
                        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-green-200/50 p-16 text-center">
                            <div class="flex flex-col items-center justify-center space-y-6 text-gray-500">
                                ...
                                <div>
                                    <p class="text-2xl font-bold text-gray-700">Belum ada materi tersimpan</p>
                                    <p class="text-gray-600 mt-2 max-w-md">Klik ikon bookmark di halaman materi untuk menyimpan.</p>
                                </div>
                            </div>
                        </div>
                    </div>
