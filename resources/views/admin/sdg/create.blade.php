                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="font-bold text-3xl text-white leading-tight">
                            {{ __('Tambah Data SDG Baru') }}
                        </h2>
                        <p class="text-green-100 text-sm mt-1">Buat Tujuan Pembangunan Berkelanjutan baru untuk sistem</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="bg-white/80 backdrop-blur-xl overflow-hidden shadow-2xl sm:rounded-3xl border border-green-200/50">
                <div class="p-6 md:p-8 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.sdg.store') }}" class="space-y-6">
                        @csrf
