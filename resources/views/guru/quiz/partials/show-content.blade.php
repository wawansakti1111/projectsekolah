{{-- resources/views/guru/quiz/partials/show-content.blade.php --}}
...
{{-- KARTU UNTUK MENAMPILKAN PERTANYAAN YANG SUDAH ADA --}}
<div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
    <section>
        <header class="flex justify-between items-center">
            <div>
                <h2 class="text-lg font-medium text-gray-900">Daftar Pertanyaan ({{ $quiz->questions->count() }})</h2>
                <p class="mt-1 text-sm text-gray-600">Berikut adalah daftar pertanyaan yang sudah ada di kuis ini.</p>
            </div>
