            ...
            <div class="relative z-10 py-6 px-8">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-green-100 text-sm mt-1">Perbarui informasi akun siswa</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form method="POST" action="{{ route('admin.siswa.update', $siswa->id) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="class_id"
                                    class="w-full px-4 py-3.5 border-2 border-green-200 rounded-xl focus:border-green-500 focus:ring-4 focus:ring-green-500/20 transition-all duration-300 appearance-none bg-white"
                                    required>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-green-800 mb-2 flex items-center gap-2">
                                ...
                                Password Baru <span class="text-green-600 font-normal">(Kosongkan jika tidak diubah)</span>
                            </label>
                            <input type="password"
                                   name="password"
                                   class="w-full px-4 py-3.5 border-2 border-green-200 rounded-xl focus:border-green-500 focus:ring-4 focus:ring-green-500/20 transition-all duration-300" />
